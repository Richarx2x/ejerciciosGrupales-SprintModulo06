...
import ejercicios.model.persistence.mapper.TrainingMapper;
import ejercicios.model.persistence.repository.TrainingRepository;
...
public class TrainingServiceImpl implements TrainingService {
    ...
    public Optional<Training> update(Training training){
        //return repository.save(mapper.toCapacitacion(training)).getId() == training.getId();
    return null;
    }
    @Override
